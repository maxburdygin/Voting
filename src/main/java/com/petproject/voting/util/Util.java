...
public class Util {
    public static final List<Meal> MEALS = Arrays.asList(
            ...
            new Meal("Chicken set #2", 2, 380D, LocalDate.of(2020, 07, 22)),
            new Meal("Beef set #1", 2, 320D, LocalDate.of(2020, 07, 22)),
            new Meal("Margharita pizza", 3, 220D, LocalDate.of(2020, 07, 22)),
            new Meal("Vegan pizza", 3, 220D, LocalDate.of(2020, 07, 22)),
            new Meal("California roll", 3, 280D, LocalDate.of(2020, 07, 22))
    );
