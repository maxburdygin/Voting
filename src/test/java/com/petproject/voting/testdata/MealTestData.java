...
public class MealTestData {
    public static TestMatcher<Meal> MEAL_MATCHER = TestMatcher.ignoringFieldsComparator("restaurant");
    ...
    public static final List<Meal> MEALS = List.of(MEAL2, MEAL5, MEAL8, MEAL1, MEAL4, MEAL7, MEAL3, MEAL6, MEAL9);
